...
import { ArrowLeft, Check, Crown, Zap, Star, Mic, Brain, FileText, MessageCircle, MapPin, Users } from "lucide-react"
  ...
  const plans = [
    {
      ...
      limitations: ["No CV analysis", "No career roadmap", "No chat assistant", "Limited to voice interviews"],
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Select the perfect plan for your interview preparation journey. All plans include our core AI technology.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-3 gap-8 mb-16">
            {plans.map((plan) => {
              ...
              return (
                <Card
                  key={plan.id}
                  className={`bg-premium-card border ${
                    plan.popular ? "border-purple-500/50 neon-purple" : "border-white/10 hover:border-white/20"
                ...
                >
                  ...
                  <CardHeader className="text-center pb-8 pt-12">
                    <div
                      className={`w-16 h-16 bg-gradient-to-br ${plan.color} rounded-2xl flex items-center justify-center mx-auto mb-6 ${plan.popular ? "neon-purple" : ""}`}
                    >
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-white/10">
                    ...
                    <th className="text-center text-white font-semibold py-4">Per Session</th>
                    <th className="text-center text-white font-semibold py-4">Weekly</th>
                    <th className="text-center text-white font-semibold py-4">Monthly</th>
                  </tr>
                </thead>
          ...
          <div className="text-center">
            ...
            <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              <div className="bg-premium-card border border-white/10 rounded-xl p-6">
                <h3 className="text-white font-semibold mb-3">How does the credit system work?</h3>
                <p className="text-gray-300">
                  Each plan gives you credits that are consumed based on usage. Voice interviews consume more credits
                  than text-based features.
                </p>
              </div>
              <div className="bg-premium-card border border-white/10 rounded-xl p-6">
                <h3 className="text-white font-semibold mb-3">Can I upgrade or downgrade anytime?</h3>
                <p className="text-gray-300">
                  Yes, you can change your plan at any time. Unused credits will be carried forward to your new plan.
                </p>
              </div>
              <div className="bg-premium-card border border-white/10 rounded-xl p-6">
                <h3 className="text-white font-semibold mb-3">Is there a free trial?</h3>
                <p className="text-gray-300">
                  New users get 3 free voice interview sessions to try our platform before choosing a plan.
                </p>
              </div>
              <div className="bg-premium-card border border-white/10 rounded-xl p-6">
