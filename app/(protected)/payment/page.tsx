...
export default function PaymentPage() {
  ...
  const plans = {
    session: {
      ...
      price: 99,
      credits: 1,
      description: "Voice Interview Only",
    },
    weekly: {
      name: "Weekly Plan",
      price: 500,
      credits: 50,
      description: "All Features for 1 Week",
    },
    monthly: {
      name: "Monthly Plan",
      price: 1000,
      credits: 150,
      description: "All Features for 1 Month",
    },
  };
        ...
        <Card className="bg-premium-card border border-green-500/50 max-w-md w-full neon-green">
          <CardContent className="text-center p-8">
            ...
            <p className="text-gray-300 mb-6">
              Your {selectedPlan.name} has been activated. You now have{" "}
  ...
  if (paymentStatus === "failed") {
    return (
      <div className="min-h-screen overflow-y-scroll bg-black flex items-center justify-center p-4">
                  ...
                  {planId === "session" ? (
                    <ul className="space-y-2 text-gray-300">
                      <li className="flex items-center">
                        <CheckCircle className="w-4 h-4 text-green-400 mr-2" />1
              ...
              <CardContent className="space-y-6">
                ...
                <div className="bg-white/5 rounded-lg p-4">
                  ...
                  <p className="text-gray-300 text-sm">
                    ...
                    encryption. We support all major payment methods including
